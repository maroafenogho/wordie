...
import 'package:wordie/src/features/notes/presentation/controllers/update_note_controller.dart';
...
class _NoteDetailsScreenState extends State<NoteDetailsScreen> {
  ...
  checkNoteUpdate({required WidgetRef ref, required noteId}) async {
    if ((titleController.text.isNotEmpty && bodyController.text.isNotEmpty) &&
        (titleController.text.trim() != widget.note.title ||
            bodyController.text.trim() != widget.note.body)) {
      await ref.watch(asyncUpdateNoteProvider.notifier).updateNote(
          noteId: noteId,
